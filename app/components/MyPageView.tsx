    ...
    <div className="pb-28">
      ...
      {isLoggedIn ? (
        <div className="mx-5 bg-white rounded-3xl p-5 shadow-sm border border-plum-100 flex items-center gap-4">
          ...
          <div>
            <p className="font-bold text-plum-900">{t("지유님")}</p>
        ...
        <div className="mx-5 bg-plum-700 rounded-3xl p-5 flex items-center justify-between">
          <div>
            <p className="font-bold text-white text-[15px]">{t("로그인하고 더 많은 기능을!")}</p>
            <p className="text-xs text-plum-200 mt-1">{t("좋아요, 코스 저장을 이용해보세요")}</p>
          </div>
      ...
      <div className="mx-5 mt-4 grid grid-cols-2 gap-3">
        <div className="bg-white rounded-2xl p-4 text-center shadow-sm border border-plum-100">
          ...
          <p className="text-xs text-plum-400 mt-0.5">{t("좋아요한 맛집")}</p>
        </div>
        <div className="bg-white rounded-2xl p-4 text-center shadow-sm border border-plum-100">
          ...
          <p className="text-xs text-plum-400 mt-0.5">{t("저장한 코스")}</p>
        </div>
      </div>
                ...
                {likedRestaurants.map(r => (
                  ...
                  >
                    ...
                    <div className="flex-1 px-4 py-3">
                      ...
                      <p className="text-xs text-plum-400 mt-0.5">{t(r.category)}</p>
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="font-bold text-plum-900">{t(c.title)}</p>
                  </div>
                ...
                <div className="flex items-center gap-1 mt-3 flex-wrap">
                  {c.spots.map((s, i) => (
                    <span key={t(s)} className="flex items-center gap-1">
